...
clock_h = {
    ...
    graduation_fg_colour=0x8ec6f7, graduation_fg_alpha=0.3,
    },
}
-- MINUTES
clock_m = {
    ...
    graph_bg_colour=0x8ec6f7,      graph_bg_alpha=0.1,
    graph_fg_colour=0x8ec6f7,      graph_fg_alpha=0.3,
    txt_radius=140,
    txt_weight=0,                  txt_size=18.0,
    txt_fg_colour=0xFFFFFF,        txt_fg_alpha=0.6,
    graduation_radius=80,
...
function conky_main()
    ...
    local cs = cairo_xlib_surface_create(conky_window.display, conky_window.drawable, conky_window.visual, 400, 900)
